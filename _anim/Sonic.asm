...
; ---------------------------------------------------------------------------
	...
	dc.w SonAni_SuperPeelout2-SonicAniData ;24
	dc.w SonAni_SuperPeelout-SonicAniData ;25
...
SonAni_SuperPeelout:	dc.b $FF,$2D,$2E,$2F,$30,$FF,$FF,$FF,$FF,$FF
SonAni_SuperPeelout2:	dc.b 1, $F,$10,$11,$12,$13,$14, $D, $E, $2D,$2E,$2F,$30, $FE, 4, 0
; ---------------------------------------------------------------------------
